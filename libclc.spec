...
Version:        0.0.1
Release:        0.%{git}%{?dist}
Summary:        An open source implementation of the library OpenCL 1.1 library requirements
...
%build
./configure.py --prefix=%{_prefix} --libexecdir=%{_libexecdir}
make %{?_smp_mflags}
...
%changelog
* Sun Jul 14 2013 Fabian Deutsch <fabiand@fedoraproject.org> - 0.0.1
- Initial package
